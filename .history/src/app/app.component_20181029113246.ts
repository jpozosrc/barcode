...
function startVideo() {
  ...
  navigator.mediaDevices.getUserMedia({ video: { deviceId: { exact: 'de8a1eb6d7c9c13b534f3885e932eec0cf5fe6b541991c70f2317cf76b7582d1' } } })
  ...
  navigator.mediaDevices.enumerateDevices()
    .then(function(devices) {
      ...
      devices.forEach(function(device) {
        ...
        elem.innerHTML = "<option value='" + device.deviceId + "'>" + device.kind + ': ' + device.label + "</option>";
